...
class KaprodiPendidikan extends CI_Controller
{
    public function __construct()
    {
        ...
        //cek login dan role
        is_logged_in();
        $this->load->model('M_kaprodipendidikan');
    }
    ...
    public function index()
    {
        ...
        $data['total_asset'] = $this->M_kaprodipendidikan->hitungJumlahDokumen();

        $this->load->view('template/header', $sess);
        $this->load->view('kaprodi/pendidikan/index', $data);
    ...
    public function detail($id_pendidikan)
    {
        ...
        $data['pendidikan'] = $this->M_kaprodipendidikan->getSinglePendidikan('id_pendidikan', $id_pendidikan);

        //ambil semua data dokumen yang ada di tabel pendidikan_transaksi yang punya id $id_pendidikan
        // $data['dokumen'] = $this->M_kaprodipendidikan->getAlldokumen('pendidikan_id', $id_pendidikan);
        ...
        //tampilan
        $this->load->view('template/header', $sess);
        $this->load->view('kaprodi/pendidikan/detail', $data);
        $this->load->view('template/footer');
        ...
        //     $cek = $this->M_kaprodipendidikan->insertDokumen($post);
        ...
        //         </div>');
        //         redirect('KaprodiPendidikan/detail/' . $id_pendidikan);
        //     } else {
    ...
    public function unggahdokumen($id_transaksi_pendidikan)
    {
        ...
        $query = $this->M_kaprodipendidikan->getSingleDokumen('id_transaksi_pendidikan', $id_transaksi_pendidikan);
        ...
        if ($this->input->post()) {
            ...
            $cek = $this->M_kaprodipendidikan->uploadDokumen($id_transaksi_pendidikan, $post);
            ...
            if ($cek) {
                ...
                redirect('KaprodiPendidikan/detail/' . $balik);
            } else {
        ...
        $this->load->view('template/header', $sess);
        $this->load->view('kaprodi/pendidikan/unggah', $data);
        $this->load->view('template/footer');
    }

    public function sendPendidikan($id_pendidikan)
    {
        //ambil data satu baris dari tabel pendidikan
        $data['pendidikan'] = $this->M_kaprodipendidikan->getOnePendidikan('id_pendidikan', $id_pendidikan);

        $this->load->view('kaprodi/pendidikan/sendPendidikan', $data);
    }
}
