                    ...
                    <div class="col-12">
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4">
                                ...
                                <p data-aos="fade-up" data-aos-delay="300"><a href="<?= site_url('auth/registration'); ?>" class="btn btn-primary py-3 px-5 btn-pill">Daftar Sekarang</a></p>
                            ...
                            <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <form action="<?= base_url('auth'); ?>" method="POST" class="form-box">
                                    <h3 class="h4 text-black mb-4">Silahkan masuk,</h3>
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-primary btn-pill mt-3" value="Masuk">
                                    </div>
                                    <hr>
                                    <a href="<?= site_url('auth/forgotpassword'); ?>">Lupa kata sandi ?</a>
                                </form>
                            </div>
                ...
                <div class="owl-carousel col-12 nonloop-block-14">
                    ...
                    foreach ($kegiatan as $k) { ?>
                        <div class="course bg-white h-100 align-self-stretch">
                            <figure class="m-0">
                                <a href="course-single.html"><img src="<?php
                                                                        if ($k['file'] == null) {
