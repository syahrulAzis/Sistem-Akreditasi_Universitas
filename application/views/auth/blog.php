                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="row justify-content-center align-items-center text-center">
                            <div class="col-lg-6">
                                <h1 data-aos="fade-up" data-aos-delay="0"><?= $blog['judul_kegiatan']; ?></h1>
                                <p data-aos="fade-up" data-aos-delay="100">&bullet; <?= $blog['peserta_kegiatan']; ?> Peserta mengikuti kegiatan ini &bullet;</p>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mb-5">
                    ...
                    <div class="mb-5">
                        <h3 class="text-black">Deskripsi Kegiatan</h3>
                        <p class="mb-4">
                            <strong class="text-black mr-3">dilaksanakan pada : </strong> <?= $blog['waktu_kegiatan']; ?>
                        </p>
                        <div class="col-md-0">
                            <img src="<?php
                                        if ($blog['file'] == null) {
                                            echo base_url('unggah/kegiatan/default.jpg');
                                        } else {
                                            echo base_url('unggah/kegiatan/') . $blog['file'];
                                        }
                                        ?>" alt="Image" class="img-fluid rounded" />
                        </div><br>
                        <p class="text-justify"><?= $blog['artikel_kegiatan']; ?></p><br>
                        <p class="mt-0"><a href="<?= base_url('auth'); ?>" class="btn btn-primary">Kembali</a></p>
                    </div>
                    ...
                    if ($query->num_rows() > 0) {
                        foreach ($query->result() as $na) { { ?>
                                ...
                                <div class="mb-5 text-center border rounded course-instructor">
                                    <h3 class="mb-5 text-black text-uppercase h6 border-bottom pb-3">Penulis Artikel</h3>
                                    <div class="mb-4 text-center">
                                        <img src="<?= base_url('unggah/profile/') . $na->image; ?>" alt="Image" class="w-50 rounded-circle mb-4" />
                                        <h3 class="h5 text-black mb-4"><?= $na->name; ?></h3>
                                        <p>
                                            <i>
                                                &ldquo;
                                                <?= $na->bio_user; ?>
        ...
        <div class="container">
            <div class="row mb-5 justify-content-center">
                <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
                    <h2 class="section-title">Kegiatan Lainnya</h2>
                            ...
                            <figure class="m-0">
                                <a href="#"><img src="<?php
                                                        ...
                                                        if ($k['file'] == null) {
                                                            ...
                                                            echo base_url('unggah/kegiatan/' . $k['file']);
                                                        }
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-md-8 text-center testimony">
                    ...
                    <h4c lass="mb-4">As Developer and Network Engineer</h4c>
                </div>
            </div>
        </div>
    </div>
