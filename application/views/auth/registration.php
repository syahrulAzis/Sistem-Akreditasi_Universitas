                       ...
                       <div class="col-12">
                           <div class="row align-items-center">
                               ...
                               <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                                   ...
                                   <form action="<?= base_url('auth/registration'); ?>" method="POST" class="form-box">

                                       <h3 class="h4 text-black mb-4">Silahkan daftar,</h3>
                                       ...
                                       <div class="form-group">
                                           <div class="input-group">
                                               <div class="input-group-prepend">
                                                   <span class="input-group-text"><i class="fa fa fa-envelope-open"></i></span>
                                               </div>
                                       ...
                                       <div class="form-group">
                                           <div class="input-group">
                                               ...
                                               <input type="password" id="password2" name="password2" class="form-control" placeholder="Konfirmasi Kata Sandi">
                                           </div>
                                           <?= form_error('password2', '<small class="text-danger pl-3">', '</small>'); ?>
                                       </div>
                                       <div class="form-group">
                                           <button class="btn btn-primary btn-pill mt-3" type="submit">DAFTAR</button>
                                       </div>
                                       <hr>
