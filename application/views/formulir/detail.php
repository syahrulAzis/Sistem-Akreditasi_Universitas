              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-dark">
                  <li class="breadcrumb-item">
                    <a href="<?= base_url('standar/detail/') . $formulir['standar_id']; ?>"><?php
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?= base_url('mp/detail/') . $formulir['mp_id']; ?>"><?php
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?= base_url('sop/detail/') . $formulir['sop_id']; ?>"><?php
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="table-responsive">
                            ...
                            <a type="button" class="btn btn-primary" href="<?php echo site_url('formulir/download/' . $formulir['id_formulir']); ?>">Unduh</a>
                            <a type="button" class="btn btn-warning" href="<?php echo site_url('formulir/update/' . $formulir['id_formulir']); ?>">Edit</a>
                            <a type="button" class="btn btn-danger" href="<?php echo site_url('formulir/delete/' . $formulir['id_formulir']); ?>" onclick="return confirm('Apakah kamu yakin ?')">Hapus</a>
                          </div>
                        </div>
                      </div>
                    </div>
