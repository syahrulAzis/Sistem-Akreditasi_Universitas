                            ...
                            <tbody>
                                ...
                                foreach ($dokumen as $row) { ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td>
                                            <a href="<?php echo site_url('Stafftu/DokumenMonev/' . $row->id_transaksi_pendidikan); ?>" target="_blank" type="button" class="btn btn-icons btn-rounded btn-outline-primary"><i class=" fa fa-eye"></i></a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('Stafftu/DokumenPerbaikan/' . $row->id_transaksi_pendidikan); ?>" target="_blank" type="button" class="btn btn-icons btn-rounded btn-outline-primary"><i class=" fa fa-eye"></i></a>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                    <a class="dropdown-item" href="<?php echo site_url('Stafftu/PengendalianUnggahPerbaikan/' . $row->id_transaksi_pendidikan); ?>">Unggah Perbaikan</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
