                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($listdocperbaikan as $ld) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-outline-danger" href="<?php echo site_url('Stafftu/RemovePerbaikan/' . $ld['id_file']); ?>" onclick="return confirm('Apakah kamu yakin ?')"><i class="fa fa-trash"></i> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            <a type="button" class="btn btn-outline-light" href="<?php echo site_url('Stafftu/DetailPendidikanPengendalian/' . $dokumen['pendidikan_id']); ?>"><i class="fa fa-undo"></i> Kembali</a>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
                </div>
