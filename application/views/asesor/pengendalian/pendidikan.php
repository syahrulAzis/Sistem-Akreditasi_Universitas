                                                ...
                                                if ($p['is_active_pendidikan'] > 3) {
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                            <a class="dropdown-item" href="' . site_url('Asesor/HasilPengendalian/' . $p['id_pendidikan']) . '?>">Hasil Pengendalian</a>
                                                            <a class="dropdown-item" href="' . site_url('Asesor/MutuPengendalian/' . $p['id_pendidikan']) . '?>">Mutu</a>
                                                        </div>
                                                    </div>';
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                        <a class="dropdown-item" href="' . site_url('Asesor/DetailPendidikanPengendalian/' . $p['id_pendidikan']) . '?>">Detail</a>
                                                        </div>
                                                    </div>';
                                                } else {
                                                    echo '
