                                                ...
                                                if ($p['is_active_pendidikan'] > 2) {
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                            <a class="dropdown-item" href="' . site_url('Asesor/HasilPendidikanEvaluasi/' . $p['id_pendidikan']) . '?>">Hasil Evaluasi</a>
                                                            <a class="dropdown-item" href="' . site_url('Asesor/MutuEvaluasi/' . $p['id_pendidikan']) . '?>">Mutu</a>
                                                        </div>
                                                    </div>';
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                            <a class="dropdown-item" href="' . site_url('Asesor/DetailPendidikanEvaluasi/' . $p['id_pendidikan']) . '?>">Detail</a>
                                                            <a class="dropdown-item" href="' . site_url('Asesor/HasilPendidikanEvaluasi/' . $p['id_pendidikan']) . '?>">Hasil Evaluasi</a>
                                                        </div>
                                                    </div>';
                                                } else {
