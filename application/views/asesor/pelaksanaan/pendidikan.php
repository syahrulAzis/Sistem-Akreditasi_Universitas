                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($p['is_active_pendidikan'] != 1) {
                                                    echo '<button class="btn btn-success icon-btn dropdown-toggle disabled" type="button" id="dropdownMenuIconButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="icon-check"></i>
                                                </button>';
                                                } else {
                                                    echo '
                                                    <div class="dropdown">
                                                        <button class="btn btn-primary icon-btn dropdown-toggle disabled" type="button" id="dropdownMenuIconButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <i class="icon-layers"></i>
                                                        </button>
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                            <a class="dropdown-item" href="' . site_url('Stafflp3m/DetailPendidikanPelaksanaan/' . $p['id_pendidikan']) . '?>">Detail</a>
                                                            <a class="dropdown-item" href="' . site_url('Stafflp3m/PelaksanaanLampiran/' . $p['id_pendidikan']) . '?>">Lampiran</a>
                                                        </div>
                                                    </div>';
                                                }
                                                ?>
