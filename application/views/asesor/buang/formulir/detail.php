                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-dark">
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('AsesorStandar/detail/') . $formulir['standar_id']; ?>"><?php
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('AsesorMP/detail/') . $formulir['mp_id']; ?>"><?php
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('AsesorSOP/detail/') . $formulir['sop_id']; ?>"><?php
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        ...
                                                        <hr>
                                                        <a type="button" class="btn btn-light" href="<?php echo site_url('AsesorFormulir'); ?>">Kembali</a>
