        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                    <a class="dropdown-item" href="<?php echo site_url('AsesorPengendalian/detailDokumen/' . $row->id_transaksi_pendidikan); ?>">Detail</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <?php
                    foreach ($pendidikan as $row) { ?>
                        <a type="button" class="btn btn-outline-warning btn-fw pull-right disabled" href="<?php echo site_url('AsesorPengendalian/sendPendidikan/' . $row->id_pendidikan_pengendalian); ?>" onclick="return confirm('Mohon cek kembali kelengkapan dokumen sebelum menyerahkan !!!')">
