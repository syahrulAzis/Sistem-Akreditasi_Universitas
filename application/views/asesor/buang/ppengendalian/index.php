                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                        <a class="dropdown-item" href="<?php echo site_url('AsesorPengendalian/selesai/' . $p['id_pendidikan_pengendalian']); ?>">Kelengkapan Dokumen</a>
                                                        <a class="dropdown-item" href="<?php echo site_url('AsesorPengendalian/perbaikan/' . $p['id_pendidikan_pengendalian']); ?>">Tindak Lanjut Pengendalian</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
