        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                    <a class="dropdown-item" href="<?php echo site_url('AsesorPendidikanEvaluasi/detailDokumen/' . $row->id_transaksi_pendidikan); ?>">Detail</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <hr>
                    <a type="button" class="btn btn-outline-danger btn-fw" href="<?php echo site_url('AsesorPendidikanEvaluasi'); ?>">
                        <i class="fa fa-undo"></i>
                        Kembali
                    </a>
                    <?php
                    foreach ($pendidikan as $row) { ?>
                        <a type="button" class="btn btn-outline-warning btn-fw pull-right" href="<?php echo site_url('AsesorPendidikanEvaluasi/sendPendidikan/' . $row->id_pendidikan_nilai); ?>" onclick="return confirm('Mohon cek kembali kelengkapan dokumen sebelum menyerahkan !!!')">
