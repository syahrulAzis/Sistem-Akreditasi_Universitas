                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <a type="button" class="btn btn-primary" href="<?php echo site_url('dokumen/add'); ?>">Tambah</a>
                                    <hr>
                                    <div class="row">
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                                        <a class="dropdown-item" href="<?php echo site_url('dokumen/edit/' . $ad['id_dokumen_pendidikan']); ?>">Edit</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a class="dropdown-item" href="<?php echo site_url('dokumen/delete/' . $ad['id_dokumen_pendidikan']); ?>" onclick="return confirm('Apakah kamu yakin ?')">Hapus</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
