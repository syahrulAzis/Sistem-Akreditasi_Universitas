                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-dark">
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('KaprodiStandar/detail/') . $formulir['standar_id']; ?>"><?php
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('KaprodiMP/detail/') . $formulir['mp_id']; ?>"><?php
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('KaprodiSOP/detail/') . $formulir['sop_id']; ?>"><?php
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        ...
                                                        <hr>
                                                        <a type="button" class="btn btn-light" href="<?php echo site_url('KaprodiFormulir'); ?>">Kembali</a>
                                                        <a type="button" class="btn btn-primary disabled" href="<?php echo site_url('formulir/download/' . $formulir['id_formulir']); ?>">Unduh</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
