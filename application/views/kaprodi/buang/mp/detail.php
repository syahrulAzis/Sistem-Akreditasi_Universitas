                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-dark">
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('KaprodiStandar/detail/') . $mp['standar_id']; ?>"><?php
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        ...
                                                        <hr>
                                                        <a type="button" class="btn btn-light" href="<?php echo site_url('KaprodiMP'); ?>">Kembali</a>
                                                        <a type="button" class="btn btn-primary disabled" href="<?php echo site_url('mp/download/' . $mp['id_mp']); ?>">Unduh</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
