        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row->file == false) {
                                                echo '<button type="button" class="btn btn-outline-light btn-fw disabled""><i class="fa fa-eye-slash"></i></button>';
                                            } else {
                                                echo '<a class="btn btn-outline-success btn-fw" href="' . base_url('unggah/pendidikan/' . $row->file) . '" target="_blank"><i class="fa fa-eye"></i></a>';
                                            }
                                            ?>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                    <a class="dropdown-item" href="<?php echo site_url('KaprodiPendidikanEvaluasi/detailDokumen/' . $row->id_transaksi_pendidikan); ?>">Detail</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <hr>
                    <p>
                        * <i>Data yang ditampilkan merupakan dokumen yang sudah diberikan penilaian oleh Asesor</i>
                    </p>
                    <hr>
                    <a type="button" class="btn btn-outline-danger btn-fw" href="<?php echo site_url('KaprodiPendidikanEvaluasi'); ?>">
