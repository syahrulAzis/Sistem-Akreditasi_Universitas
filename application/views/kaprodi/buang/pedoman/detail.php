                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        ...
                                                        <hr>
                                                        <a type="button" class="btn btn-light" href="<?php echo site_url('KaprodiPedoman'); ?>">Kembali</a>
                                                        <a type="button" class="btn btn-primary disabled" href="<?php echo site_url('pedoman/download/' . $pedoman['id_pedoman']); ?>">Unduh</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
