                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-dark">
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('KaprodiStandar/detail/') . $sop['standar_id']; ?>"><?php
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('KaprodiMP/detail/') . $sop['mp_id']; ?>"><?php
                                                                                                        $id_mp = $sop['mp_id'];
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        ...
                                                        <hr>
                                                        <a type="button" class="btn btn-light" href="<?php echo site_url('KaprodiSOP'); ?>">Kembali</a>
                                                        <a type="button" class="btn btn-primary disabled" href="<?php echo site_url('sop/download/' . $sop['id_sop']); ?>">Unduh</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
