                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                        <a class="dropdown-item" href="<?php echo site_url('EvaluasiPendidikan/nilai/' . $p['id_pendidikan_nilai']); ?>">Nilai</a>
                                                        <a class="dropdown-item" href="<?php echo site_url('EvaluasiPendidikan/detail/' . $p['id_pendidikan_nilai']); ?>">Detail</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
