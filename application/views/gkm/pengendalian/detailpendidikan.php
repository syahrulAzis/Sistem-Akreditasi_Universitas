                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                    <a class="dropdown-item" href="<?php echo site_url('Gkm/PengendalianJadwalPerbaikan/' . $row->id_transaksi_pendidikan); ?>">Jadwal Perbaikan</a>
                                                    <a class="dropdown-item" href="<?php echo site_url('Gkm/PengendalianJadwalPengendalian/' . $row->id_transaksi_pendidikan); ?>">Jadwal Pengendalian</a>
                                                    <a class="dropdown-item" href="<?php echo site_url('Gkm/PengendalianUnggahPerbaikan/' . $row->id_transaksi_pendidikan); ?>">Unggah Perbaikan</a>
                                                    <a class="dropdown-item" href="<?php echo site_url('Gkm/PengendalianDetailDokumen/' . $row->id_transaksi_pendidikan); ?>">Detail</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
