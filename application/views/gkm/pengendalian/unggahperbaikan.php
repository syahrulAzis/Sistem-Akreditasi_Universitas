                                    ...
                                    <tbody>
                                        ...
                                        foreach ($listdocperbaikan as $ld) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-outline-danger" href="<?php echo site_url('Gkm/RemovePerbaikan/' . $ld['id_file']); ?>" onclick="return confirm('Apakah kamu yakin ?')"><i class="fa fa-trash"></i> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
