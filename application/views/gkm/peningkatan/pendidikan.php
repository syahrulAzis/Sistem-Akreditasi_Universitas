                                                ...
                                                if ($p['is_active_pendidikan'] != 4) {
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                            <a class="dropdown-item" href="' . site_url('Gkm/ReportPeningkatan/' . $p['id_pendidikan']) . '?>">Report Monev</a>
                                                            <a class="dropdown-item" href="' . site_url('Gkm/MutuPeningkatan/' . $p['id_pendidikan']) . '?>">Mutu</a>
                                                            <a class="dropdown-item" href="' . site_url('Gkm/PengendalianLampiran/' . $p['id_pendidikan']) . '?>">Lampiran</a>
                                                        </div>
                                                    </div>';
                                                }
                                                ?>
