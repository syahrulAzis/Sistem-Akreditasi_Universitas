                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="progress">
                                                    ...
                                                    $jumlah = $jum_dok -  $isi_dok;

                                                    $persen = $jumlah / $jum_dok * 100;
                                                ...
                                                if ($p['is_active_pendidikan'] > 2) {
                                                    echo '
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                                <a class="dropdown-item" href="' . site_url('Gkm/HasilPendidikanEvaluasi/' . $p['id_pendidikan']) . '?>">Hasil Evaluasi</a>
                                                                <a class="dropdown-item" href="' . site_url('Gkm/MutuEvaluasi/' . $p['id_pendidikan']) . '?>">Mutu</a>
                                                            </div>
                                                        </div>';
                                                    ...
                                                    echo '
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                                <a class="dropdown-item" href="' . site_url('Gkm/DetailPendidikanEvaluasi/' . $p['id_pendidikan']) . '?>">Detail</a>
                                                                <a class="dropdown-item" href="' . site_url('Gkm/HasilPendidikanEvaluasi/' . $p['id_pendidikan']) . '?>">Hasil Evaluasi</a>
                                                                <a class="dropdown-item" href="' . site_url('Gkm/EvaluasiLampiran/' . $p['id_pendidikan']) . '?>">Lampiran</a>
                                                            </div>
                                                        </div>';
                                                }
                                                ?>
