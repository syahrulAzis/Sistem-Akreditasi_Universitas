              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-dark">
                  <li class="breadcrumb-item">
                    <a href="<?= base_url('standar/detail/') . $mp['standar_id']; ?>"><?php
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="table-responsive">
                            ...
                            <a type="button" class="btn btn-primary" href="<?php echo site_url('mp/download/' . $mp['id_mp']); ?>">Unduh</a>
                            <a type="button" class="btn btn-warning" href="<?php echo site_url('mp/update/' . $mp['id_mp']); ?>">Edit</a>
                            <a type="button" class="btn btn-danger" href="<?php echo site_url('mp/delete/' . $mp['id_mp']); ?>" onclick="return confirm('Apakah kamu yakin ?')">Hapus</a>
                          </div>
                        </div>
                      </div>
                    </div>
