                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="rencana_pengendalian" id="rencana_pengendalian" value="<?= $dokumen['rencana_pengendalian']; ?>">
                            </div>
                            <div class="form-group">
                                <label>Jadwal Pengendalian</label>
                                <input type="date" class="form-control" name="jadwal_pengendalian" id="jadwal_pengendalian" value="<?= $dokumen['jadwal_pengendalian']; ?>">
                            </div>
                            <div class="form-group">
