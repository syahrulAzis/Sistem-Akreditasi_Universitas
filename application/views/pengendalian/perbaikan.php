        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                    <a class="dropdown-item" href="<?php echo site_url('PengendalianPendidikan/jadwalPerbaikan/' . $row->id_transaksi_pendidikan); ?>">Perbaikan</a>
                                                    <a class="dropdown-item" href="<?php echo site_url('PengendalianPendidikan/jadwalPengendalian/' . $row->id_transaksi_pendidikan); ?>">Pengendalian</a>
                                                    <a class="dropdown-item" href="<?php echo site_url('PengendalianPendidikan/unggahPerbaikan/' . $row->id_transaksi_pendidikan); ?>">Unggah</a>
                                                    <a class="dropdown-item" href="<?php echo site_url('PengendalianPendidikan/nilaiPerbaikan/' . $row->id_transaksi_pendidikan); ?>">Nilai</a>
                                                    <a class="dropdown-item" href="<?php echo site_url('PengendalianPendidikan/hasilPerbaikan/' . $row->id_transaksi_pendidikan); ?>">Hasil</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <hr>
                    <a type="button" class="btn btn-outline-danger btn-fw" href="<?php echo site_url('PengendalianPendidikan'); ?>">
                        <i class="fa fa-undo"></i>
                        Kembali
                    </a>
                    <?php
                    foreach ($pendidikan as $row) { ?>
                        <a type="button" class="btn btn-outline-warning btn-fw pull-right" href="<?php echo site_url('PengendalianPendidikan/sendPendidikan/' . $row->id_pendidikan_pengendalian); ?>" onclick="return confirm('Mohon cek kembali kelengkapan dokumen sebelum menyerahkan !!!')">
