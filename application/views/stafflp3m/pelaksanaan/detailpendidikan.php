        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                    <a class="dropdown-item" href="<?php echo site_url('Stafflp3m/UnggahDokumen/' . $row['id_transaksi_pendidikan']); ?>">Unggah</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <hr>
                    <a type="button" class="btn btn-outline-light btn-fw" href="<?php echo site_url('Stafflp3m/PelaksanaanPendidikan'); ?>">
