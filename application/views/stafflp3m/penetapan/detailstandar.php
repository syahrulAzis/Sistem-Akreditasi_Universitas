                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        ...
                                                        <hr>
                                                        <a type="button" class="btn btn-outline-light" href="<?php echo site_url('Stafflp3m/PenetapanStandar'); ?>"><i class="fa fa-undo"></i> Kembali</a>
                                                        <a type="button" class="btn btn-outline-primary disabled" href="<?php echo site_url('standar/download/' . $standar['id_standar']); ?>"><i class="fa fa-download"></i>Unduh</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
