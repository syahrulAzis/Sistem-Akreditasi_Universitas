                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single w-100" name="status_perbaikan" id="status_perbaikan" required>
                                    <option value="<?= $dokumen['status_perbaikan']; ?>">Please Select ...</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="capaian_perbaikan" id="capaian_perbaikan" value="<?= $dokumen['capaian_perbaikan']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Akar Masalah Perbaikan</label>
                                <input type="text" class="form-control" name="masalah_perbaikan" id="masalah_perbaikan" value="<?= $dokumen['masalah_perbaikan']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Tindakan Koreksi Perbaikan</label>
                                <input type="text" class="form-control" name="perbaikan_dokumen" id="perbaikan_dokumen" value="<?= $dokumen['perbaikan_dokumen']; ?>" required>
                            </div>
                            <hr>
                            <button type="submit" class="btn btn-outline-success mr-2"><i class="fa fa-save"></i> Simpan</button>
                            <a type="button" class="btn btn-outline-light" href="<?php echo site_url('Stafflp3m/DetailPendidikanPengendalian/' . $dokumen['pendidikan_id']); ?>"><i class="fa fa-undo"></i> Kembali</a>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
                </div>
