                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="rencana_perbaikan" id="rencana_perbaikan" value="<?= $dokumen['rencana_perbaikan']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Jadwal Perbaikan</label>
                                <input type="date" class="form-control" name="jadwal_perbaikan" id="jadwal_perbaikan" value="<?= $dokumen['jadwal_perbaikan']; ?>" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single w-100" name="penanggung_jawab_perbaikan" id="penanggung_jawab_perbaikan" required>
                                    <option value="<?= $dokumen['penanggung_jawab_perbaikan']; ?>">Please Select ...</option>
