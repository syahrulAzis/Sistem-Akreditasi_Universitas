                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="rencana_pengendalian" id="rencana_pengendalian" value="<?= $dokumen['rencana_pengendalian']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Jadwal Pengendalian</label>
                                <input type="date" class="form-control" name="jadwal_pengendalian" id="jadwal_pengendalian" value="<?= $dokumen['jadwal_pengendalian']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Penanggung Jawab Pengendalian</label>
                                <select class="js-example-basic-single w-100" name="penanggung_jawab_pengendalian" id="penanggung_jawab_pengendalian" required>
                                    <option value="<?= $dokumen['penanggung_jawab_pengendalian']; ?>">Please Select ...</option>
                                    <?php foreach ($ambiluser as $s) : ?>
