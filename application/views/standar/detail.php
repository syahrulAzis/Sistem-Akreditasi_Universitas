                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="table-responsive">
                            ...
                            <a type="button" class="btn btn-primary" href="<?php echo site_url('standar/download/' . $standar['id_standar']); ?>">Unduh</a>
                            <a type="button" class="btn btn-warning" href="<?php echo site_url('standar/update/' . $standar['id_standar']); ?>">Edit</a>
                            <a type="button" class="btn btn-danger" href="<?php echo site_url('standar/delete/' . $standar['id_standar']); ?>" onclick="return confirm('Apakah kamu yakin ?')">Hapus</a>
                          </div>
                        </div>
                      </div>
                    </div>
