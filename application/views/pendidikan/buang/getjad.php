                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <a type="button" class="btn btn-primary" href="<?php echo site_url('pendidikan/addjad'); ?>">Tambah</a>
                                    <hr>
                                    <div class="row">
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                                        <a class="dropdown-item" href="<?php echo site_url('pendidikan/updatejad/' . $j['id_jad']); ?>">Edit</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a class="dropdown-item" href="<?php echo site_url('pendidikan/deletejad/' . $j['id_jad']); ?>" onclick="return confirm('Apakah kamu yakin ?')">Hapus</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
