                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                        <a class="dropdown-item" href="<?php echo site_url('PeningkatanPendidikan/kelengkapan/' . $p['id_pendidikan_peningkatan']); ?>">Kelengkapan Dokumen</a>
                                                        <a class="dropdown-item" href="<?php echo site_url('PeningkatanPendidikan/pengendalian/' . $p['id_pendidikan_peningkatan']); ?>">Tindak Lanjut Pengendalian</a>
                                                        <a class="dropdown-item" href="<?php echo site_url('PeningkatanPendidikan/lampiran/' . $p['id_pendidikan_peningkatan']); ?>">Lampiran</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
