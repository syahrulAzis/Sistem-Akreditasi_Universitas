                                                    ...
                                                    echo '
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                                <a class="dropdown-item" href="' . site_url('Dosen/HasilPendidikanEvaluasi/' . $p['id_pendidikan']) . '?>">Hasil Evaluasi</a>
                                                                <a class="dropdown-item" href="' . site_url('Dosen/MutuEvaluasi/' . $p['id_pendidikan']) . '?>">Mutu</a>
                                                            </div>
                                                        </div>';
