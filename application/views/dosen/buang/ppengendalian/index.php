                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                        <a class="dropdown-item" href="<?php echo site_url('DosenPengendalian/perbaikan/' . $p['id_pendidikan_pengendalian']); ?>">Perbaikan</a>
                                                        <a class="dropdown-item" href="<?php echo site_url('DosenPengendalian/selesai/' . $p['id_pendidikan_pengendalian']); ?>">Selesai</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
