                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($p['is_active_pendidikan'] != 4) {
                                                    echo '<button class="btn btn-primary icon-btn dropdown-toggle disabled" type="button" id="dropdownMenuIconButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                            <a class="dropdown-item" href="' . site_url('Dosen/ReportPeningkatan/' . $p['id_pendidikan']) . '?>">Report</a>
                                                            <a class="dropdown-item" href="' . site_url('Dosen/MutuPeningkatan/' . $p['id_pendidikan']) . '?>">Mutu</a>
                                                            <a class="dropdown-item" href="' . site_url('Dosen/PengendalianLampiran/' . $p['id_pendidikan']) . '?>">Lampiran</a>
                                                        </div>
                                                    </div>';
                                                }
                                                ?>
