        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                foreach ($dokumen as $row) { ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td>
                                            <a href="<?php echo site_url('Dosen/DokumenMonev/' . $row->id_transaksi_pendidikan); ?>" target="_blank" type="button" class="btn btn-icons btn-rounded btn-outline-primary"><i class=" fa fa-eye"></i></a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('Dosen/DokumenPerbaikan/' . $row->id_transaksi_pendidikan); ?>" target="_blank" type="button" class="btn btn-icons btn-rounded btn-outline-primary"><i class=" fa fa-eye"></i></a>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                    <a class="dropdown-item" href="<?php echo site_url('Dosen/PengendalianUnggahPerbaikan/' . $row->id_transaksi_pendidikan); ?>">Unggah Perbaikan</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <hr>
                    <a type="button" class="btn btn-outline-light btn-fw" href="<?php echo site_url('Dosen/PengendalianPendidikan'); ?>">
