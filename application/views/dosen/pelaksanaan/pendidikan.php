                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($p['is_active_pendidikan'] != 1) {
                                                    echo '
                                                    <div class="dropdown">
                                                        <button class="btn btn-success icon-btn dropdown-toggle disabled" type="button" id="dropdownMenuIconButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton6">
                                                            <a class="dropdown-item" href="' . site_url('Dosen/DetailPendidikanPelaksanaan/' . $p['id_pendidikan']) . '?>">Detail</a>
                                                        </div>
                                                    </div>';
                                                }
                                                ?>
