                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($listdoc as $ld) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-outline-danger" href="<?php echo site_url('Dosen/RemoveDokumen/' . $ld['id_file']); ?>" onclick="return confirm('Apakah kamu yakin ?')"><i class="fa fa-trash"></i> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            <a type="button" class="btn btn-outline-light" href="<?php echo site_url('Dosen/DetailPendidikanPelaksanaan/' . $dokumen['pendidikan_id']); ?>"><i class="fa fa-undo"></i> Kembali</a>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
                </div>
