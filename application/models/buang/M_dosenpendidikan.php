...
class M_dosenpendidikan extends CI_Model
{
    public function getPendidikan($field, $value)
    {
        $this->db->select('*');
    ...
    public function getDokumenedit($field, $value)
    {
        $this->db->where($field, $value);
        return $this->db->get('pendidikan_transaksi');
    }
    ...
    public function updateDokumen($id_transaksi_pendidikan, $post)
    {
        $this->db->where('id_transaksi_pendidikan', $id_transaksi_pendidikan);
        $this->db->update('pendidikan_transaksi', $post);
        return $this->db->affected_rows();
