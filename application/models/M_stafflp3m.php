...
class M_stafflp3m extends CI_Model
{
    ...
    public function uploadPerbaikan($post)
    {
        $this->db->insert('pendidikan_fileperbaikan', $post);
        return $this->db->insert_id();
    }

    public function uploadLampiran($post)
    {
        $this->db->insert('pendidikan_lampiran', $post);
        return $this->db->insert_id();
    }
